 ...
 * [D compiler](https://dlang.org/download.html). See the following files for
   ...
   The current tested DMD range has the same minimum and maximum version.
   DMD v2.112.0 builds and passes `make check`. Integration tests are still
   not guaranteed when using DMD.
